...
const AdvancedSpecsModal = ({ isOpen, onClose, deviceName, category = 'mobile' }) => {
    ...
    // Config for visible specs based on category
    const visibleSpecs = {
        mobile: { thermal: true, sustained: true, iso: true, sensor: true, cpu: true, endurance: true },
        laptop: { thermal: true, sustained: true, iso: false, sensor: false, cpu: true, endurance: true },
        tablet: { thermal: true, sustained: true, iso: false, sensor: false, cpu: true, endurance: true },
        camera: { thermal: true, sustained: false, iso: true, sensor: true, cpu: false, endurance: true },
        smartwatch: { thermal: false, sustained: false, iso: false, sensor: false, cpu: true, endurance: true },
        other: { thermal: true, sustained: true, iso: false, sensor: false, cpu: true, endurance: true }
    };

    const config = visibleSpecs[category] || visibleSpecs.other;
                    ...
                    {config.cpu && (
                      ...
                      a 15.9155 15.9155 0 0 1 0 -31.831"
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#000' }}>High</div>
